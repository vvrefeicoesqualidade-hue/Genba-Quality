...
.splash-logo-row { display: flex; align-items: center; justify-content: center; gap: 10px; margin-bottom: 6px; }
.splash-logo-icon { width: 40px; height: 40px; flex-shrink: 0; }
.splash-logo-text { font-size: 26px; font-weight: 800; color: #F4FBF5; letter-spacing: -0.4px; }
.splash-logo-sub { font-size: 12.5px; color: #9FD8A8; margin-bottom: 30px; }
...
.splash-slogan { font-size: 13px; color: #5DAF78; margin-bottom: 34px; }
...
<div class="splash-wrap">
    <div class="splash-logo-row">
        <div class="splash-logo-text">VV Refeições</div>
    </div>
    <div class="splash-logo-sub">A refeição caseira da sua empresa</div>
